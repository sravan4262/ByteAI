...
public sealed class CommentCreatedEventHandlerTests : IDisposable
{
    ...
    public CommentCreatedEventHandlerTests()
    {
        ...
        _db.Users.AddRange(
            new User { Id = _commentAuthorId, ClerkId = "clerk_c1", Username = "commenter", DisplayName = "Commenter", Xp = 0 },
            new User { Id = _contentAuthorId, ClerkId = "clerk_c2", Username = "content_author", DisplayName = "Content Author", Xp = 0 });
        _db.SaveChanges();
