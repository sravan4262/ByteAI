...
public sealed class UserFollowedEventHandlerTests : IDisposable
{
    ...
    public UserFollowedEventHandlerTests()
    {
        ...
        _db.Users.AddRange(
            new User { Id = _followerId, ClerkId = "clerk_f1", Username = "follower", DisplayName = "Follower" },
            new User { Id = _followingId, ClerkId = "clerk_f2", Username = "following", DisplayName = "Following", Xp = 0 });
        _db.SaveChanges();
