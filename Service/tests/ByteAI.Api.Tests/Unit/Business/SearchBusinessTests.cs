...
public sealed class SearchBusinessTests
{
    ...
    {
        _sut = new SearchBusiness(_searchService.Object, _embedding.Object);
    }
    ...
    public async Task SearchContent_BytesType_OnlyQueriesBytes()
    {
        ...
        _searchService
            .Setup(s => s.SearchBytesAsync("react hooks", It.IsAny<Vector?>(), 10, default))
        ...
        _searchService.Verify(s => s.SearchInterviewsAsync(It.IsAny<string>(), It.IsAny<Vector?>(), It.IsAny<int>(), default), Times.Never);
    }
    ...
    public async Task SearchContent_InterviewsType_OnlyQueriesInterviews()
    {
        ...
        _searchService
            .Setup(s => s.SearchInterviewsAsync("system design", It.IsAny<Vector?>(), 10, default))
        ...
        _searchService.Verify(s => s.SearchBytesAsync(It.IsAny<string>(), It.IsAny<Vector?>(), It.IsAny<int>(), default), Times.Never);
    }
    ...
    public async Task SearchContent_AllType_QueriesBothAndMerges()
    {
        ...
        _searchService
            .Setup(s => s.SearchBytesAsync("python", It.IsAny<Vector?>(), 5, default))
        ...
        _searchService
            .Setup(s => s.SearchInterviewsAsync("python", It.IsAny<Vector?>(), 5, default))
    ...
    public async Task SearchContent_AllType_ResultsCappedAtLimit()
    {
        ...
        _searchService.Setup(s => s.SearchBytesAsync("go", It.IsAny<Vector?>(), 5, default)).ReturnsAsync(manyBytes);
        _searchService.Setup(s => s.SearchInterviewsAsync("go", It.IsAny<Vector?>(), 5, default)).ReturnsAsync(manyInterviews);
    ...
    public async Task SearchPeople_DelegatesToService()
    {
        ...
        _searchService.Setup(s => s.SearchPeopleAsync("alice", 10, default)).ReturnsAsync(users);
    ...
    {
        _searchService.Setup(s => s.SearchBytesAsync("", null, 10, default)).ReturnsAsync([]);
