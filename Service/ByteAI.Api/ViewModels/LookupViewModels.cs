...
public sealed record SubdomainResponse(Guid Id, Guid DomainId, string Name, string Label, int SortOrder);
public sealed record TechStackResponse(Guid Id, Guid SubdomainId, string Name, string Label, int SortOrder);
