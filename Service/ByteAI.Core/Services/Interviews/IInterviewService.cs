...
public interface IInterviewService
{
    ...
    Task<Interview> CreateInterviewWithQuestionsAsync(Guid authorId, string title, string? company, string? role, string? location, string difficulty, List<InterviewQuestionInput> questions, bool isAnonymous, CancellationToken ct);
